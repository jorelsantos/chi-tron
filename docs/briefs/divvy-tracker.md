...
stations    (from discovery; today gbfs/1.1/chi/en/station_information.json)
status      (from discovery; today gbfs/1.1/chi/en/station_status.json)
# Do not hardcode the version prefix — Lyft moved 2.3 → 1.1
```
...
**`station_information.json` — 2046 stations** (verified 2026-08-13; discovery now serves GBFS 1.1)
...
- Expect roughly 240 KB (2046 rows).
